 ...
 */
 ...
 function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Nope.... you answered ${userAnswer}. The correct answer was actually ${calculatedAnswer[0]}.`);
...
function calculateCorrectAnswer() {
    ...
    if (operator === '+') {
        ...
        alert(`Error, unimplemented operator ${operator}`);
        throw `Error, unimplemented operator ${operator}. Aborting`;
    }
